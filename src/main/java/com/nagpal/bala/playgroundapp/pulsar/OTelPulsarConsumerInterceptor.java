...
public class OTelPulsarConsumerInterceptor implements ConsumerInterceptor {

    private final Tracer tracer =
            GlobalOpenTelemetry.getTracer(OTelPulsarConsumerInterceptor.class.getName(), "1.0");
