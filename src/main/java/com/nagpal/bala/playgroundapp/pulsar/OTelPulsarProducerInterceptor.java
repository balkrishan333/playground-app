...
public class OTelPulsarProducerInterceptor implements ProducerInterceptor {

    private final Tracer tracer =
            GlobalOpenTelemetry.getTracer(OTelPulsarProducerInterceptor.class.getName(), "1.0");
